...
<body class="flex min-h-screen flex-col bg-gray-50">
    ...
    <header class="border-b border-gray-200 bg-white">
        <div class="mx-auto max-w-4xl px-6 py-6">
            <span class="text-2xl font-bold text-amber-500">Alif Taxi</span>
        </div>
    </header>
...
- Title matches the admin panel name "Alif Taxi"
...
| Test Method | What It Verifies |
|---|---|
| `test_landing_page_loads_for_guest` | GET `/`, assert 200, assert `assertSee('Alif Taxi')` |
| `test_landing_page_contains_hero_heading` | GET `/`, assert `assertSee('Your Alif Taxi Service')` |
...
| `test_guest_sees_landing_page_at_root` | GET `/` without auth, assert 200, assert `assertSee('Alif Taxi')` |
| `test_authenticated_driver_sees_landing_page` | Login as driver, GET `/`, assert 200 (not redirected), assert `assertSee('Alif Taxi')` |
| `test_authenticated_client_sees_landing_page` | Login as client, GET `/`, assert 200 (not redirected), assert `assertSee('Alif Taxi')` |
