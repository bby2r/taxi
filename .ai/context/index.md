...
Alif Taxi — a taxi dispatch app for a small village in Kyrgyzstan (Bishkek region). Flat-rate pricing, cash or bank transfer payments, admin-managed drivers, phone OTP auth for clients. Binary feedback system (👍/👎). Drivers can cancel with reasons. Client blacklist for repeat offenders.
