            ...
            <table class="w-full text-left text-sm">
                <thead class="border-b border-gray-200 bg-gray-50 text-xs uppercase tracking-wider text-gray-500">
                    <tr>
                        ...
                        <th class="px-6 py-3">Дневной тариф</th>
                        <th class="px-6 py-3">Ночной тариф</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($regions as $region)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-gray-700">{{ number_format($region->day_price) }} сом</td>
                            <td class="whitespace-nowrap px-6 py-4 text-gray-700">{{ number_format($region->night_price) }} сом</td>
