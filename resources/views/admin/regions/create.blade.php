            ...
            <form method="POST" action="{{ route('admin.regions.store') }}">
                ...
                <div class="mb-5 rounded-lg border border-amber-200 bg-amber-50 p-4">
                    <label class="flex items-start gap-3">
                        <input type="checkbox" name="is_intercity_only" value="1" {{ old('is_intercity_only') ? 'checked' : '' }} class="mt-0.5 rounded border-gray-300 text-amber-500 focus:ring-amber-400">
                        <span class="text-sm">
