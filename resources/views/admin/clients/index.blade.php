...
@section('content')
    ...
    <div class="mb-6 flex items-center justify-between">
        <p class="text-sm text-gray-600">Total: {{ $clients->total() }} clients</p>
    </div>
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($clients as $client)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-gray-500">{{ $client->created_at->format('M d, Y') }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-gray-500">No clients found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
