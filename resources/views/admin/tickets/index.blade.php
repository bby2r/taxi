                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($tickets as $ticket)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-gray-700">{{ $ticket->user?->name ?? '—' }}</td>
                            <td class="whitespace-nowrap px-6 py-4 text-gray-700">{{ ucfirst(str_replace('_', ' ', $ticket->field)) }}</td>
                            <td class="whitespace-nowrap px-6 py-4 text-gray-500">{{ $ticket->old_value ?? '—' }}</td>
                            <td class="whitespace-nowrap px-6 py-4 text-gray-700">{{ $ticket->new_value }}</td>
