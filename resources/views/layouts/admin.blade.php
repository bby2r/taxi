    ...
    <div class="flex min-h-screen">
        ...
        <aside class="flex w-64 flex-col bg-gray-800">
            ...
            <nav class="mt-2 flex-1 space-y-1 px-3">
                <a
                    ...
                    class="{{ request()->routeIs('admin.dashboard') ? 'bg-gray-900 text-amber-400' : 'text-gray-300 hover:bg-gray-700' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium"
                >
                ...
                <a
                    ...
                    class="{{ request()->routeIs('admin.drivers.*') ? 'bg-gray-900 text-amber-400' : 'text-gray-300 hover:bg-gray-700' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium"
                >
                ...
                <a
                    ...
                    class="{{ request()->routeIs('admin.region-routes.*') ? 'bg-gray-900 text-amber-400' : 'text-gray-300 hover:bg-gray-700' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium"
                >
                    {{-- Heroicon: table-cells (outline) --}}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                ...
                <a
                    href="{{ route('admin.intercity-routes.index') }}"
                    class="{{ request()->routeIs('admin.intercity-routes.*') ? 'bg-gray-900 text-amber-400' : 'text-gray-300 hover:bg-gray-700' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium"
                >
                    {{-- Heroicon: truck (outline) --}}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                ...
                <a
                    href="{{ route('admin.intercity-schedules.index') }}"
                    class="{{ request()->routeIs('admin.intercity-schedules.*') ? 'bg-gray-900 text-amber-400' : 'text-gray-300 hover:bg-gray-700' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium"
                >
                ...
                <a
                    href="{{ route('admin.intercity-trips.index') }}"
                    class="{{ request()->routeIs('admin.intercity-trips.*') ? 'bg-gray-900 text-amber-400' : 'text-gray-300 hover:bg-gray-700' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium"
                >
                ...
                <a
                    ...
                    class="{{ request()->routeIs('admin.orders.*') ? 'bg-gray-900 text-amber-400' : 'text-gray-300 hover:bg-gray-700' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium"
                >
                ...
                <a
                    ...
                    class="{{ request()->routeIs('admin.billing.*') ? 'bg-gray-900 text-amber-400' : 'text-gray-300 hover:bg-gray-700' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium"
                >
                ...
                <a
                    href="{{ route('admin.otps.index') }}"
                    class="{{ request()->routeIs('admin.otps.*') ? 'bg-gray-900 text-amber-400' : 'text-gray-300 hover:bg-gray-700' }} flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium"
                >
        ...
        <div class="flex flex-1 flex-col">
            ...
            <header class="flex items-center justify-between border-b border-gray-200 bg-white px-8 py-4">
                <h2 class="text-lg font-semibold text-gray-900">@yield('heading')</h2>
