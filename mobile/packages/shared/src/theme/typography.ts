...
export const Typography = {
  ...
  // 16/800 — section titles inside cards (e.g. route names, modal headings).
  h4: { fontFamily, fontSize: 16, fontWeight: '800', lineHeight: 22, letterSpacing: -0.2 } as TextStyle,
